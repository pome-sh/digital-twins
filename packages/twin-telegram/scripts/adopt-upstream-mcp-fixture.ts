...
const DROPPED: Record<string, string> = {
  ...
  "create_channel": "Not modeled by the twin's current user-MCP membership slice; this fixture serves group create/invite/leave, participant and admin reads, title/about/photo edits, promote/demote/ban/remove, default permissions, slow mode, and the admin log. Channels and invite-link joins stay dropped.",
  "get_invite_link": "Not modeled by the twin's current user-MCP membership slice; this fixture serves group create/invite/leave, participant and admin reads, title/about/photo edits, promote/demote/ban/remove, default permissions, slow mode, and the admin log. Channels and invite-link joins stay dropped.",
  "join_chat_by_link": "Not modeled by the twin's current user-MCP membership slice; this fixture serves group create/invite/leave, participant and admin reads, title/about/photo edits, promote/demote/ban/remove, default permissions, slow mode, and the admin log. Channels and invite-link joins stay dropped.",
  "export_chat_invite": "Not modeled by the twin's current user-MCP membership slice; this fixture serves group create/invite/leave, participant and admin reads, title/about/photo edits, promote/demote/ban/remove, default permissions, slow mode, and the admin log. Channels and invite-link joins stay dropped.",
  "import_chat_invite": "Not modeled by the twin's current user-MCP membership slice; this fixture serves group create/invite/leave, participant and admin reads, title/about/photo edits, promote/demote/ban/remove, default permissions, slow mode, and the admin log. Channels and invite-link joins stay dropped.",
