...
const DROPPED: Record<string, string> = {
  ...
  "create_group": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "invite_to_group": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "leave_chat": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "get_participants": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "create_channel": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "edit_chat_title": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "edit_chat_photo": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "edit_chat_about": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "delete_chat_photo": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "promote_admin": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "demote_admin": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "ban_user": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "unban_user": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "remove_user": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "set_default_chat_permissions": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "toggle_slow_mode": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "edit_admin_rights": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "get_admins": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "get_banned_users": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "get_invite_link": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "join_chat_by_link": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "export_chat_invite": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "import_chat_invite": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "get_recent_actions": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "send_file": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "send_album": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "download_media": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "send_voice": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "upload_file": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "get_media_info": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "get_sticker_sets": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "send_sticker": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "get_gif_search": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "send_gif": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "list_photos": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "open_photo": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
  "get_photo_sheet": "Not modeled by the twin's current user-MCP interaction slice; this fixture serves only its account, pin, regular-poll, standard-emoji-reaction, and inline-callback source rows.",
...
const meta = {
  ...
  configuration: {
    derivation: "Subtract-only projection of the approved oss-source capture. The interaction rows this twin fulfills (pins, regular polls, emoji reactions, and inline callback inspection/press) plus account lookup are carried verbatim; every other registration is named in projection.dropped.",
