...
const meta = {
  ...
  configuration: {
    derivation: "Subtract-only projection of the approved oss-source capture. The interaction rows this twin fulfills (pins, regular polls, emoji reactions, and inline callback inspection/press), account lookup, and the media rows over the existing SQLite store (get_media_info, download_media, send_file, send_voice, send_sticker, get_sticker_sets) are carried verbatim; every other registration is named in projection.dropped.",
