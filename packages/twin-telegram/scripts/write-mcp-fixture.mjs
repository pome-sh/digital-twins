...
const tools = [
  ...
  { name: "message_from_link", description: "Resolve a seeded tg:// or t.me link.", inputSchema: { type: "object", properties: { account: { type: "string" }, link: { type: "string" } }, required: ["link"] } },
