...
transcription. Nothing about that changed. What the declaration work added is
publication through the same seam as the other twins — `route-inputs.json`
carries both halves, the GraphQL arguments under
...
input SHAPES are out of scope here.
...
### `extensions`: declared and answered, not ignored
