...
//
// This is DATA, and it lives alone. It used to live in `tools.ts`, next
...
// sentence it cannot honour, and the damage runs in both
...
//
// This is the first member added for a POSITIVE criterion rather than a
...
// assertion.
//
// It is deliberately ONE name and not the remaining ~37. That ticket owns
...
// one worth pulling forward is that M0's slice depended on it while the sweep did
