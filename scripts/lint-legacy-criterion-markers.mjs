...
//   - cli/src/task/parseTask.ts — the parser's legacy-marker
//     detection + migration-hint error message.
//   - cli/test/unit/parseTask.test.ts — the rejection tests for that
//     detection.
...
const ALLOWLIST = new Set([
  "cli/src/task/parseTask.ts",
  "cli/test/unit/parseTask.test.ts",
